            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <button class="flex ms-2 md:me-24">
                        ...
                        <span
                            class="self-center text-lg font-bold sm:text-2xl whitespace-nowrap dark:text-white">PURE<span
                                class="text-green-500">CART</span></span>
                    </button>
                </div>
                <div class="flex items-center">
                    <div class="flex items-center ms-3">
                        ...
                        <div class="z-40 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded-sm shadow-sm dark:bg-gray-700 dark:divide-gray-600"
                            id="dropdown-user">
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
            <ul class="space-y-2 font-medium">
                ...
                <?php elseif(auth()->user()->role == 'petugas'): ?>
                    ...
                    <li>
                        <a href="<?php echo e(route('petugas.product.index')); ?>"
                            class="flex items-center p-2 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                            <svg class="shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white"
                                aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor"
                                viewBox="0 0 18 18">
...
<?php /**PATH C:\xampp\htdocs\UKK_Kasir_App\resources\views\layouts\dashboard.blade.php ENDPATH**/ ?>