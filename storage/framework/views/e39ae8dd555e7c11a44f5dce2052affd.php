<?php $__env->startSection('content'); ?>
    ...
    <div class="border border-gray-200 p-4 rounded-md w-[1000px]">
        <div>
            <div class="flex">
                <a href="<?php echo e(route('admin.penjualan.exportExcelPenjualan')); ?>"
                    ...
                    <?php $__currentLoopData = $penjualans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $penjualan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo e(route('admin.penjualan.PrintPDF', $penjualan->id)); ?>"
                                        ...
                                        <?php if($penjualan->member): ?>
                                            <div class="flex justify-between">
                                                <div class="text-sm">
                                                    ...
                                                    <p>Poin Tersisa : <?php echo e($penjualan->member->PoinToBeUsed); ?></p>
                                                </div>
                                                <div class="text-sm">
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\UKK_Kasir_App\resources\views/admin/sales/index.blade.php ENDPATH**/ ?>