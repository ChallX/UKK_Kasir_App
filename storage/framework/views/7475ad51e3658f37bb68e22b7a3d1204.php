    ...
    <div class="border border-gray-200 p-4 rounded-md w-[1000px]">
        <div>
            <div class="flex justify-between">
                <a href="<?php echo e(route('admin.user.exportExcel')); ?>"
                ...
                <tbody>
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <button type="button" data-modal-target="update-modal-<?php echo e($user->id); ?>"
                                    data-modal-toggle="update-modal-<?php echo e($user->id); ?>"
                                ...
                                <button type="button" data-modal-target="popup-modal-<?php echo e($user->id); ?>"
                                    data-modal-toggle="popup-modal-<?php echo e($user->id); ?>"
                        ...
                        <div id="update-modal-<?php echo e($user->id); ?>" data-modal-backdrop="static" tabindex="-1"
                            aria-hidden="true"
                                ...
                                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                    <div
                                        ...
                                        <button type="button"
                                            ...
                                            data-modal-hide="update-modal-<?php echo e($user->id); ?>">
                                    ...
                                    <div class="p-4 md:p-5 space-y-4">
                                        <form action="<?php echo e(route('admin.user.update', $user->id)); ?>" method="POST"
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <input type="text" value="<?php echo e($user->name); ?>" id="name"
                                                    name="name"
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <select id="role" name="role"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                                    <option value="admin"
                                                        <?php if($user->role == 'admin'): ?> selected <?php endif; ?>>admin
                                                    </option>
                                                    <option value="petugas"
                                                        <?php if($user->role == 'petugas'): ?> selected <?php endif; ?>>
                                                        petugas</option>
                                                </select>
                                            </div>
                                            <button type="submit"
                        ...
                        <div id="popup-modal-<?php echo e($user->id); ?>" tabindex="-1"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-md max-h-full">
                                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                    <button type="button"
                                        class="absolute top-3 end-2.5 text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                        data-modal-hide="popup-modal-<?php echo e($user->id); ?>">
                                        <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                            fill="none" viewBox="0 0 14 14">
                                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                    ...
                                    <div class="p-4 md:p-5 text-center">
                                        ...
                                        <form action="<?php echo e(route('admin.user.delete', $user->id)); ?>" method="POST">
                                            ...
                                            <button data-modal-hide="popup-modal-<?php echo e($user->id); ?>" type="submit"
                                                class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 dark:focus:ring-red-800 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                                                Yes, I'm sure
                                            </button>
                                            <button data-modal-hide="popup-modal-<?php echo e($user->id); ?>" type="button"
...
<?php echo $__env->make('layouts.dashboard', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\UKK_Kasir_App\resources\views\admin\user\index.blade.php ENDPATH**/ ?>