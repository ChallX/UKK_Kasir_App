...
@section('content')
    ...
    <div class="border border-gray-200 p-4 rounded-md w-[1000px]">
        <div>
            <div class="flex">
                <button type="button" class="ml-auto text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-sm text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Export Penjualan (.xlsx)</button>
            </div>
