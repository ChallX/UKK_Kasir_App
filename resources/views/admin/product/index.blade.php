...
@section('content')
    ...
    <div class="border border-gray-200 p-4 rounded-md w-[1000px]">
        <div class="flex justify-between mb-5">
            <a href="{{ route('admin.product.exportExcel') }}"
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr>
                            ...
                            <td>{{ $product->stock }}</td>
                            <td>
                                <button type="button" data-modal-target="update-modal-{{ $product->id }}"
                                ...
                                <button type="button" data-modal-target="update-stok-modal-{{ $product->id }}"
                                    data-modal-toggle="update-stok-modal-{{ $product->id }}"
                                    class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:focus:ring-yellow-900">Update Stok</button>
                        ...
                        <div id="update-modal-{{ $product->id }}" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
                                ...
                                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                    <div
                                        ...
                                        <button type="button"
                                            ...
                                            data-modal-hide="update-modal-{{ $product->id }}">
                                    ...
                                    <div class="p-4 md:p-5 space-y-4">
                                        <form action="{{ route('admin.product.update', $product->id) }}" method="POST"
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <input type="number" value="{{ $product->stock }}" name="stock" id="stok" disabled
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    required />
                                            </div>
                                            <div class="mb-5">
                        ...
                        <div id="update-stok-modal-{{ $product->id }}" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-80 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-3xl max-h-full">
                                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                    <div
                                        ...
                                        <button type="button"
                                            class="text-gray-400 bg-transparent hover:bg-gray-200 hover:text-gray-900 rounded-lg text-sm w-8 h-8 ms-auto inline-flex justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                            data-modal-hide="update-stok-modal-{{ $product->id }}">
                                            <svg class="w-3 h-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                                                fill="none" viewBox="0 0 14 14">
                                                <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                                    stroke-width="2" d="m1 1 6 6m0 0 6 6M7 7l6-6M7 7l-6 6" />
                                    ...
                                    <div class="p-4 md:p-5 space-y-4">
                                        <form action="{{ route('admin.product.updateStock', $product->id) }}" method="POST"
                                            ...
                                            <div class="mb-5">
                                                <label for="stok"
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Stock</label>
                                                <input type="number" value="{{ $product->stock }}" name="stock" id="stok"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    required />
                                            </div>
                                            <button type="submit"
