            ...
            <table id="search-table">
                ...
                <tbody>
                    @foreach ($products as $product)
                        <tr>
                            <td><img src="{{ asset(path: '/storage/produk/' . $product->image) }}" alt="" width="100">
                            </td>
                        ...
                        <div id="update-modal-{{ $product->id }}" data-modal-backdrop="static" tabindex="-1"
                            aria-hidden="true"
                                        ...
                                        <form action="{{ route('admin.product.update', $product->id) }}" method="POST"
                                            ...
                                            <div class="mb-5">
                                                <label for="nama_product"
                                                    ...
                                                    Product</label>
                                                <input type="text" value="{{ $product->nama_product }}"
                                            ...
                                            <div class="mb-5">
                                                ...
                                                <input type="number" value="{{ $product->harga }}" name="harga"
                                                    id="harga"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    required />
                                            </div>
                        ...
                        <div id="update-stok-modal-{{ $product->id }}" data-modal-backdrop="static" tabindex="-1"
                            aria-hidden="true"
                            class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-80 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
                            <div class="relative p-4 w-full max-w-3xl max-h-full">
                                <div class="relative bg-white rounded-lg shadow-sm dark:bg-gray-700">
                                    ...
                                    <div class="p-4 md:p-5 space-y-4">
                                        <form action="{{ route('admin.product.updateStock', $product->id) }}"
                                            ...
                                            <div class="mb-5">
                                                <label for="nama_product"
                                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                                                    Product</label>
                                                <input type="text" disabled value="{{ $product->nama_product }}"
                                                    id="nama_product" name="nama_product"
                                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                                    required />
                                            </div>
