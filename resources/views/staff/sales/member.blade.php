            ...
            <div class="w-[450px]">
                <form action="{{ route('petugas.penjualan.memberUpdate') }}" method="post">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" value="{{ $member->PoinToBeUsed }}" id="poin"
                        ...
                        <p class="text-xs text-red-400"> Poin Yang Didapat Pada Transaksi Ini Belum Dapat Digunakan ({{ $member->StoredPoin }})</p>
                    </div>
                    <button type="submit"
