...
        <div class="border gap-4 border-gray-200 grid grid-cols-3 justify-end rounded p-10">
...
                            <button type="button" onclick="increaseQty({{ $product->id }}, {{ $product->stok }})">+</button>
                        </div>
