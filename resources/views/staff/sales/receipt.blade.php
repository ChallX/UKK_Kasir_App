...
@section('content')
    ...
    <div class="border w-[1000px] gap-4 bg-gray-200 border-gray-200 rounded p-5">
        ...
        <div class="bg-white p-8 rounded">
            <div class="flex mb-5">
                <button type="button"
                    class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Unduh</button>
